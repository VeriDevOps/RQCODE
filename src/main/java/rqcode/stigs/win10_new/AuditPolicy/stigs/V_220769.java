...
public class V_220769 extends AuditPolicyPattern {
...
AuditPolicyConst.AUDIT_POLICY_SCRIPT_PATTERN_CHECK, AuditPolicyConst.AUDIT_POLICY_SCRIPT_PATTERN_ENFORCE,
                    ...
                    Map.of(
                        "description", "The system must be configured to audit Policy Change - Authorization Policy Change successes."
                        )
                );
