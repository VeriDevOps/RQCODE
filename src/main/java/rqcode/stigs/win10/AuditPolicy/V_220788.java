...
/**
 * V_220788: Windows 10 must be configured to audit other Logon/Logoff Events Failures.
 *
 ...
 */
public class V_220788 extends AuditPolStig {
        /**
         * Initiating parameters for the check script
        */
        private final static Map<String, String> CHECK_VALUES = Map.of(
                        "id", "V_220788",
                        "guid", "Other Logon/Logoff Events",
                        "subcat_es", "errores",
                        "subcat_eng", "failure"
                        );
        ...
        private final static Map<String, String> INFO = Map.ofEntries(
                        Map.entry("id", "V_220788"),
                        Map.entry("title", "Windows 10 must be configured to audit other Logon/Logoff Events Failures."),
                        Map.entry("date", "2021-08-18"),
                        Map.entry("ruleID", "SV_220788r569187_rule"),
                        ...
                        Map.entry("fixtext", "Configure the policy value for Computer Configuration >> Windows Settings >> Security Settings >> Advanced Audit Policy Configuration >> System Audit Policies >> Logon/Logoff >> \"Audit Other Logon/Logoff Events\" with \"Failure\" selected."),
                        ...
                        Map.entry("version", "WN10-AU-000565")
                        );
        ...
        public static void main(String[] args) {
                STIG stig = new V_220788();
                //running command line interface for V_220788
                cli(stig, args);
        }
