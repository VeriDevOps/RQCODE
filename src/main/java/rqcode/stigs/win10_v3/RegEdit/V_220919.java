...
public class V_220919 extends RegEditStig {
    ...
    private final static Map<String, String> INFO = Map.ofEntries(
            ...
            Map.entry("checktext", "Enabling camera access from the lock screen could allow for unauthorized use. Requiring logon will ensure the device is only used by authorized personnel."),
