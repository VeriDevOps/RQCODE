...
import rqcode.stigs.win10_v3.UserRights.V_220957;
...
public class Windows10SecurityTechnicalImplementationGuide {
    ...
    public static void main(String[] args) {
        System.out.println(v_220982.enforce());
        System.out.println(v_220982.check());
        System.out.println(v_220982.toString());
