...
public class V_63709 extends RegistryEditPattern {
    private final RegistryEditScriptPattern pattern =
            new RegistryEditScriptPattern(RegistryEditConst.REGISTRY_EDIT_SCRIPT_PATTERN, "HKLM:\\SOFTWARE\\Policies\\Microsoft\\MicrosoftEdge\\Main", "FormSuggest Passwords", "DWORD", "no");
